(function(jQuery) {
  ...
  var defaultShortDateFormat = "yyyy-MM-dd";
  var defaultLongDateFormat = "yyyy-MM-dd HH:mm:ss";
  ...
  jQuery.format = (function() {
    ...
    return {
      ...
      toBrowserTimeZone : function(value, format) {
        return this.date(new Date(value), format || 'yyyy-MM-dd HH:mm:ss');
      },
      shortDate : function(value) {
          return this.date(new Date(value), defaultShortDateFormat );
      },
      longDate : function(value) {
          return this.date(new Date(value), defaultLongDateFormat );
      }
    };
  }());
}(jQuery));
