...
<html>
<head>
	<title><fmt:message key="common.form.create"/><fmt:message key="entity.company" bundle="${org}"/></title>
...
<body>
	...
	<form id="inputForm" action="${ctx}/org/company/${action}" method="post" class="form-horizontal">
	
			<legend><small><fmt:message key="common.form.create"/><fmt:message key="entity.company" bundle="${org}"/></small></legend>
...
<span class="icon-asterisk  icon-orange"></span>
			...
			<div class="control-group">
				<label for="parentLabel" class="control-label"><fmt:message key="entity.company.parent" bundle="${org}"/>:</label>
