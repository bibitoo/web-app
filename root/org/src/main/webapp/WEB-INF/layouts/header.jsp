                ...
                <div class="container">
                    ...
                    <div class="nav-collapse collapse">
                        ...
                        <div id="help" class="pull-right">
                        	 ...
                        	 <ul class="nav nav-pills">
                        	 	<li class="dropdown"><tags:userCompany /></li>
                        	    <li>
                        	    	<shiro:guest><a href="${propertyConfigurer['sso.loginUrl']}"><fmt:message key="core.user.login"/></a></shiro:guest>
                        	    </li>
                        	 	<li  <shiro:user>class="dropdown"</shiro:user>>
                        	 		 <shiro:user>
											...
											<ul class="dropdown-menu">
												...
												<li><a href="${propertyConfigurer['sso.casServerUrlPrefix']}/logout?service=${propertyConfigurer['sso.casService']}"><fmt:message key="user.logout"/></a></li>
											</ul>
									</shiro:user>
									<shiro:guest>
