...
public class CookieUtils {
	...
	public static String COOKIE_TOKEN_KEY = "LandKingSessionContext";
	public static long expiredTime = 8*60*60;
    ...
    public static void setCookie(HttpServletRequest request, HttpServletResponse response, String name, String value) {  
        // Save the cookie value for exploro livecycle   
    ...
    public static void setToken(HttpServletRequest request, HttpServletResponse response,  String value){

    	setCookie(request, response, COOKIE_TOKEN_KEY, value);
    	
    }
    public static String getToken(HttpServletRequest httpRequest, HttpServletResponse response){
    	
    	Cookie cookie = CookieUtils.getCookie(httpRequest,
				CookieUtils.COOKIE_TOKEN_KEY);
